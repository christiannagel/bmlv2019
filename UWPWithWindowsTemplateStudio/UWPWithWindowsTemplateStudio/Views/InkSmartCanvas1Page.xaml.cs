...
using UWPWithWindowsTemplateStudio.Services.Ink;
...
namespace UWPWithWindowsTemplateStudio.Views
{
    ...
    public sealed partial class InkSmartCanvas1Page : Page
    {
        public InkSmartCanvas1ViewModel ViewModel { get; } = new InkSmartCanvas1ViewModel();

        public InkSmartCanvas1Page()
        {
            InitializeComponent();
